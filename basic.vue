...
module.exports =
  components:
    "resizer": require "../unidirectional.js"
  data: ->
    style1:
      width: 100
      height: 40
    ...
    contentHeight4: 0
  attached: ->
    @contentWidth1 = @$els.content1.offsetWidth
    @contentWidth2 = @$els.content2.offsetWidth
    @contentHeight3 = @$els.content3.offsetHeight
    @contentHeight4 = @$els.content4.offsetHeight
</script>
